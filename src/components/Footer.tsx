...
const Footer = () => {
  ...
  const isFutureAuditPage = location.pathname === '/future-audit';

  return (
    <footer className={`w-full max-w-7xl mx-auto px-6 border-x border-grid relative flex flex-col items-center text-center overflow-hidden mt-auto ${isFutureAuditPage ? 'py-12' : 'py-40'}`}>
      ...
      <div className={`${isFutureAuditPage ? 'mt-0' : 'mt-40'} w-full flex flex-col md:flex-row justify-between items-center border-t border-grid pt-10 font-mono text-[10px] tracking-widest uppercase text-lab relative z-10`}>
